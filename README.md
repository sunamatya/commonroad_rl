...
Configurations and trained models used in our experiments in the paper can be downloaded [here](https://syncandshare.lrz.de/getlink/fi6Ls1EF6zNDZs2VpDKb38eR/models.zip).
